import { PullRequestReviewCommentReactionRecord } from "../../types/record.js";
import { loadJson } from "@gh-stats/io";
import { writeProcessedSISO } from "../../io/write-processed.js";
import { daysBetween } from "../utils/date.js";

const processName = "pull-request-review-comment-reactions";

export async function process(): Promise<void> {
  const raw = await loadJson<PullRequestReviewCommentReactionRecord[]>(
